...
public class center_test extends BaseActivity{
    ...
    void initView(){
        aCache = ACache.get(center_test.this);
    ...
    void setListeners(){
        ...
        nicknameBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                View nicknameView = LayoutInflater.from(center_test.this).inflate(R.layout.dialog_edittext,null);
                final EditText nicknameEdit = nicknameView.findViewById(R.id.edit);
                // 弹昵称修改框
                AlertDialog.Builder builder = new AlertDialog.Builder(center_test.this);
                ...
                builder.setPositiveButton(getResources().getString(R.string.confirm), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        Util.makeToast(center_test.this,getResources().getString(R.string.modify_success));
                        // 通知MainActivity更新昵称
        ...
        birthBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Date date = new Date();
                View dateView = LayoutInflater.from(center_test.this).inflate(R.layout.dialog_birthdate,null);
        ...
        heightBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                View heightView = LayoutInflater.from(center_test.this).inflate(R.layout.dialog_wheelview, null);
        ...
        exitBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                SharedPreferencesUtil spu = new SharedPreferencesUtil(center_test.this);
        ...
        photoUtil.setOnPhotoResultListener(new PhotoUtil.OnPhotoResultListener() {
            ...
            public void onPhotoResult(final Uri uri) {
                if (uri != null && !TextUtils.isEmpty(uri.getPath())) {
                    final Bitmap bitmap = PhotoUtil.decodeUriAsBitmap(center_test.this,uri);
...
/*        String dateStr = new SimpleDateFormat("yyyy-MM-dd", Locale.CHINA).format(user.getBirthDate());
    ...
    void showPhotoDialog(){
        ...
        builder.setItems(choices, new DialogInterface.OnClickListener()
        {
            ...
            {
                PhotoUtil.OnPhotoResultListener onPhotoResultListener = new PhotoUtil.OnPhotoResultListener() {
                    @Override
                    public void onPhotoResult(Uri uri) {
                        Bitmap bitmap = PhotoUtil.decodeUriAsBitmap(center_test.this,uri);
                        avatarImage.setImageBitmap(bitmap);
                    }
                ...
                photoUtil.setOnPhotoResultListener(onPhotoResultListener);
                switch(which)
                {
                    ...
                    case 0:// 相机
                        ...
                        intent.putExtra(MediaStore.EXTRA_OUTPUT,photoUtil.buildUri(center_test.this));
    ...
    public void onActivityResult(Activity activity, int requestCode, int resultCode, Intent data) {
        if (photoUtil.onPhotoResultListener == null) {
        ...
        switch (requestCode) {
            //拍照
            case 1:
                if (new File(photoUtil.buildUri(activity).getPath()).exists()) {
                    if (crop(activity, photoUtil.buildUri(activity))) {
                        return;
                    }
                    photoUtil.onPhotoResultListener.onPhotoCancel();
                }
                break;
            //https://www.jianshu.com/p/fcc7f8507211直接将图片加载
            ...
            //截图
            case 3:
                if (resultCode == Activity.RESULT_OK && new File(photoUtil.buildUri(activity).getPath()).exists()) {
                    photoUtil.onPhotoResultListener.onPhotoResult(photoUtil.buildUri(activity));
                }
                break;
        }
    }
    ...
    private boolean crop(Activity activity, Uri uri) {
        ...
        Uri cropuri = photoUtil.buildUri(activity);
        cropIntent.putExtra(MediaStore.EXTRA_OUTPUT, cropuri);
        if (!photoUtil.isIntentAvailable(activity, cropIntent)) {
            return false;
        } else {
            try {
                activity.startActivityForResult(cropIntent, 3);
                return true;
            } catch (Exception e) {
                e.printStackTrace();
                return false;
    ...
    private void showResponse(final String msg) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(center_test.this, msg, Toast.LENGTH_SHORT).show();
            }
        });
    }
